...
array("menu_name"=>"","menu_text"=>"Trang chu","menu_link"=>"index.php","active"=>""),//active chi la hien vong tron
array("menu_name"=>"category","menu_text"=>"Loai san pham","menu_link"=>"index.php?admin=category","active"=>""),
array("menu_name"=>"news","menu_text"=>"Sản Phẩm","menu_link"=>"index.php?admin=news","active"=>"")
);
